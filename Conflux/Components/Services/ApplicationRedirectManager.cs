...
internal sealed class ApplicationRedirectManager(NavigationManager navigationManager, ProtectedSessionStorage sessionStorage)  {
    ...
    public struct RedirectBuilder {
        ...
        public RedirectBuilder WithCookie(string key, string value, HttpContext httpContext) {
            httpContext.Response.Cookies.Append(key, value, ShortLivedCookieBuilder.Build(httpContext));
            return this;
        }
